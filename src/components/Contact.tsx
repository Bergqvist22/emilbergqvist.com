        ...
        <div className="grid md:grid-cols-[1fr_1.5fr] gap-16 items-start">
          ...
          >
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-foreground">
              Let's <span className="italic font-normal">work</span>
              <br />together
            </h2>
          </motion.div>
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="flex w-full rounded-md border border-input bg-background px-4 py-3 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 resize-none"
                />
              </div>
              <button
                type="submit"
