...
const Projects = () => {
  return (
    <section id="projects" className="py-20 sm:py-32 px-4 sm:px-6 bg-card">
        ...
        <div className="space-y-0 divide-y divide-border">
          {projects.map((project, index) => (
            <motion.article
              ...
              className="group py-6 sm:py-8 md:py-10 cursor-pointer"
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="font-heading text-xl sm:text-2xl md:text-3xl font-semibold text-foreground group-hover:text-primary transition-colors duration-300">
                      {project.title}
                    </h3>
                    <ArrowUpRight
                      size={18}
                      className="text-muted-foreground group-hover:text-primary group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300 shrink-0"
                    />
                  </div>
                ...
                <div className="flex items-center gap-4 md:flex-col md:items-end mt-2 md:mt-0">
                  <span className="text-xs sm:text-sm text-muted-foreground font-mono">{project.year}</span>
